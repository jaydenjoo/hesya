...
describe("KpiCard — Epic 4 ε", () => {
  ...
  it("coming-soon state — dashed border + peach-50/60 bg + navy/35 value", () => {
    const { container } = render(
      <KpiCard
        label="월 매출"
        value="—"
    ...
    expect(container.querySelector(".text-hesya-navy-900\\/35")).toBeTruthy();
