        ...
        <ServicesManager
          ...
          labels={{
            ...
            editor: {
              ...
              aiProposalThinking: t("editorAiProposalThinking"),
              aiProposalDisclaimer: t("editorAiProposalDisclaimer"),
              aiProposalEdit: t("editorAiProposalEdit"),
              aiProposalDismiss: t("editorAiProposalDismiss"),
              aiProposalApply: t("editorAiProposalApply"),
