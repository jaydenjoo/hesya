...
// 1:1 reproduction of docs/design/handoff/app-4.jsx (Section 10 — Female lens).
// All sub-sections are static except BeforeAfter (auto-sweep on mount + drag).
// Kept as a single client module to mirror the handoff structure (Section 5
// pattern). page.tsx renders <Section10 /> as a client island and the surrounding
// /design-system route stays ○ Static prerendered.
    ...
    <section className="ds-section" id="s10">
      <div className="page">
        <header className="section-head">
          ...
          <div className="meta">
            <div className="eyebrow">Female lens · v2.0</div>
            <h2>
              Trust, <em>read by behavior</em>.
            </h2>
            <p>
              The female lens lives in safety signals, shareability, and visual
              verification — not in pink ribbons. The rose and share-glow tokens
        ...
        >
          <div>
            ...
            <div className="share-actions">
              <span className="act">
                <Icon.upload size={12} /> Save
              </span>
              <span className="act">
                <Icon.camera size={12} /> Story
              </span>
              <span className="act">
                <Icon.link size={12} /> Copy link
              </span>
            </div>
          </div>
          <div style={{ paddingTop: 8 }}>
        ...
        >
          <div className="ai-reply-card">
            <div className="ai-head">
              <Icon.sparkles size={14} color="var(--hesya-amber-600)" />
        ...
        >
          ...
          <i>
            &ldquo;for women&rdquo;, &ldquo;girly&rdquo;, &ldquo;pretty&rdquo;,
            &ldquo;sweet&rdquo;, &ldquo;cute&rdquo;
          </i>
          . The rose and share-glow tokens are subdued by design — they signal
          warmth and trust, not gendered marketing.
        </div>
      </div>
    </section>
  );
