...
export const mockStoreRegionDistribution: StoreRegionDistribution = {
  regions: [
    { code: "11", name: "서울", stores: 58, x: 38, y: 32 },
    { code: "26", name: "부산", stores: 18, x: 64, y: 70 },
    { code: "27", name: "대구", stores: 9, x: 56, y: 58 },
    { code: "28", name: "인천", stores: 8, x: 30, y: 33 },
    { code: "29", name: "광주", stores: 5, x: 40, y: 70 },
    { code: "30", name: "대전", stores: 6, x: 44, y: 50 },
    { code: "31", name: "울산", stores: 4, x: 66, y: 62 },
    { code: "36", name: "세종", stores: 1, x: 42, y: 46 },
    { code: "41", name: "경기", stores: 21, x: 42, y: 35 },
    { code: "42", name: "강원", stores: 3, x: 56, y: 26 },
    { code: "43", name: "충북", stores: 2, x: 48, y: 44 },
    { code: "44", name: "충남", stores: 3, x: 36, y: 47 },
    { code: "45", name: "전북", stores: 1, x: 38, y: 60 },
    { code: "46", name: "전남", stores: 1, x: 36, y: 72 },
    { code: "47", name: "경북", stores: 1, x: 58, y: 50 },
    { code: "48", name: "경남", stores: 1, x: 54, y: 68 },
    { code: "50", name: "제주", stores: 0, x: 32, y: 88 },
  ],
  unknown: 0,
  empty: false,
};
